...
@section('content')
<div class="card">
    <div class="head"><h2>Edit Grade</h2><div class="muted">{{ $student->sname }} | {{ $grading?->grading }} | {{ $grading?->sy }}</div></div>
    <form method="post" action="{{ route('grades.update', $student->id) }}">
        ...
        <div style="margin-top:12px;"><button type="submit">Update Grade</button></div>
    </form>
</div>
